...
public abstract class AbstractFileServlet extends HttpServlet {
    ...
    protected abstract FileStream getResource(HttpServletRequest req, HttpServletResponse resp);
    
    protected boolean forceDownload(HttpServletRequest request, HttpServletResponse response){
    	return false;
    }
            ...
            throws IOException
    {
        ...
        FileStream resource = getResource(request, response);
        ...
        boolean forceDownload = forceDownload(request, response);
        ...
        else if (!forceDownload && !contentType.startsWith("image")) {
        ...
        try {
            ...
            if (ranges.isEmpty() || ranges.get(0) == full) {
                ...
                if (content) {
                    ...
                    // Copy full range.
                    fileRepository.serveFile(resource, output, r.start, r.length);
                }
