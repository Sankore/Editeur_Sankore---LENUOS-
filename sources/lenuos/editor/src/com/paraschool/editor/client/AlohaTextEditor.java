...
public final class AlohaTextEditor {
	...
	private static native void bind() /*-{
		...
		var f = function(event, eventProperties){
			@com.paraschool.editor.client.AlohaTextEditor::onEdit(Lcom/google/gwt/dom/client/Element;Z)(eventProperties.editable.obj[0], eventProperties.editable.isModified());
		};
