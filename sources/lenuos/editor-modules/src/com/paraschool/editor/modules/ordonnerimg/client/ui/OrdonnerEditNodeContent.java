 ...
 * By bathily
 */
public class OrdonnerEditNodeContent extends Composite implements NodeContent {
	...
	public OrdonnerEditNodeContent(EventBus eventBus, EditModuleContext context, OrdonnerModuleMessages messages) {
	...
	private void makeEditable(Blocs blocs, int column, BlocObject object, BlocJSO jso) {
		Button resource = MediaButtonFactory.createTinyAddMediaButton();
		new EditableMedia(eventBus, context, object.resource, resource, null, ModuleObject.Type.IMAGE);
