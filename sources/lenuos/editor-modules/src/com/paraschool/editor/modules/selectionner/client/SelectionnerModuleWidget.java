...
import com.paraschool.editor.modules.selectionner.client.ui.EditWidget;
import com.paraschool.editor.modules.selectionner.client.ui.ViewWidget;

/*
 * Created at 5 sept. 2010
 * By bathily
 */
public class SelectionnerModuleWidget implements ModuleWidget {

	private EditWidget editWidget;
	private ViewWidget viewWidget;
	
	private SelectionnerModuleMessages messages;
	
	public SelectionnerModuleWidget(SelectionnerModuleMessages messages) {
		super();
